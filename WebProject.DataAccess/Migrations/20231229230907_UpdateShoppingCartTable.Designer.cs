...
namespace WebProject.DataAccess.Migrations
{
    ...
    [Migration("20231229230907_UpdateShoppingCartTable")]
            ...
            modelBuilder.Entity("WebProject.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDateTime = new DateTime(2023, 12, 29, 23, 9, 6, 462, DateTimeKind.Local).AddTicks(8976),
                            DisplayOrder = 1,
                            Name = "Action"
                        },
                        new
                        {
                            Id = 2,
                            CreatedDateTime = new DateTime(2023, 12, 29, 23, 9, 6, 462, DateTimeKind.Local).AddTicks(9029),
                            DisplayOrder = 2,
                            Name = "SciFi"
                        },
                        new
                        {
                            Id = 3,
                            CreatedDateTime = new DateTime(2023, 12, 29, 23, 9, 6, 462, DateTimeKind.Local).AddTicks(9031),
                            DisplayOrder = 3,
                            Name = "History"
                        });
                });
