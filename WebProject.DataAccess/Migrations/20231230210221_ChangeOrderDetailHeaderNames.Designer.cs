...
namespace WebProject.DataAccess.Migrations
{
    ...
    [Migration("20231230210221_ChangeOrderDetailHeaderNames")]
    partial class ChangeOrderDetailHeaderNames
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebProject.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDateTime = new DateTime(2023, 12, 30, 21, 2, 20, 340, DateTimeKind.Local).AddTicks(9986),
                            DisplayOrder = 1,
                            Name = "Action"
                        },
                        new
                        {
                            Id = 2,
                            CreatedDateTime = new DateTime(2023, 12, 30, 21, 2, 20, 341, DateTimeKind.Local).AddTicks(38),
                            DisplayOrder = 2,
                            Name = "SciFi"
                        },
                        new
                        {
                            Id = 3,
                            CreatedDateTime = new DateTime(2023, 12, 30, 21, 2, 20, 341, DateTimeKind.Local).AddTicks(40),
                            DisplayOrder = 3,
                            Name = "History"
                        });
                });
            ...
            modelBuilder.Entity("WebProject.Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebProject.Models.OrderDetail", b =>
                {
                    b.HasOne("WebProject.Models.OrderHeader", "OrderHeader")
                        .WithMany()
