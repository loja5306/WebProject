...
namespace WebProject.DataAccess.Migrations
{
    ...
    [Migration("20231224185252_AddShoppingCartToDb")]
            ...
            modelBuilder.Entity("WebProject.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDateTime = new DateTime(2023, 12, 24, 18, 52, 51, 168, DateTimeKind.Local).AddTicks(1066),
                            DisplayOrder = 1,
                            Name = "Action"
                        },
                        new
                        {
                            Id = 2,
                            CreatedDateTime = new DateTime(2023, 12, 24, 18, 52, 51, 168, DateTimeKind.Local).AddTicks(1118),
                            DisplayOrder = 2,
                            Name = "SciFi"
                        },
                        new
                        {
                            Id = 3,
                            CreatedDateTime = new DateTime(2023, 12, 24, 18, 52, 51, 168, DateTimeKind.Local).AddTicks(1119),
                            DisplayOrder = 3,
                            Name = "History"
                        });
                });
